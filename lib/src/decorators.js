...
function PathParam(name) {
    return function (_target, methodName, index) {
        var target = _target;
        core_1.addConfiguration(target);
        core_1.addMethodConfiguration(target, methodName);
...
function ResParam() {
    return function (_target, methodName, index) {
        ...
        core_1.addConfiguration(target);
        core_1.addMethodConfiguration(target, methodName);
        target.$$controllerConfiguration.methodsParameters[methodName][index] = { index: index, type: interfaces_1.ParameterType.RES_PARAMETER };
    };
}
...
function ReqParam() {
    return function (_target, methodName, index) {
        ...
        core_1.addConfiguration(target);
        core_1.addMethodConfiguration(target, methodName);
        target.$$controllerConfiguration.methodsParameters[methodName][index] = { index: index, type: interfaces_1.ParameterType.REQ_PARAMETER };
    };
}
...
function BodyParam() {
    return function (_target, methodName, index) {
        ...
        core_1.addConfiguration(target);
        core_1.addMethodConfiguration(target, methodName);
        target.$$controllerConfiguration.methodsParameters[methodName][index] = { index: index, type: interfaces_1.ParameterType.BODY_PARAMETER };
    };
}
