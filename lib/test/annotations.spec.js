...
describe('Annotations', function () {
    describe('@ReqParam', function () {
        it('should add parameter request information to configuration', function () {
            function target() { }
            ;
            annotations.ReqParam()(target, 'method', 3);
            assert(target.$$controllerConfiguration.methodsParameters['method'][3]);
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].index, 3);
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].type, interfaces_1.ParameterType.REQ_PARAMETER);
        });
    });
    describe('@ResParam', function () {
        it('should add parameter response information to configuration', function () {
            function target() { }
            ;
            annotations.ResParam()(target, 'method', 3);
            assert(target.$$controllerConfiguration.methodsParameters['method'][3]);
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].index, 3);
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].type, interfaces_1.ParameterType.RES_PARAMETER);
        });
    });
    describe('@BodyParam', function () {
        it('should add parameter body information to configuration', function () {
            function target() { }
            ;
            annotations.BodyParam()(target, 'method', 3);
            assert(target.$$controllerConfiguration.methodsParameters['method'][3]);
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].index, 3);
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].type, interfaces_1.ParameterType.BODY_PARAMETER);
        });
    });
    describe('@QueryParam', function () {
        it('should add parameter query information to configuration', function () {
            function target() { }
            ;
            annotations.QueryParam('name')(target, 'method', 3);
            assert(target.$$controllerConfiguration.methodsParameters['method'][3]);
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].index, 3);
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].name, 'name');
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].type, interfaces_1.ParameterType.QUERY_PARAMETER);
        });
    });
    describe('@PathParam', function () {
        it('should add parameter path information to configuration', function () {
            function target() { }
            ;
            annotations.PathParam('name')(target, 'method', 3);
            assert(target.$$controllerConfiguration.methodsParameters['method'][3]);
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].index, 3);
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].name, 'name');
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][3].type, interfaces_1.ParameterType.PATH_PARAMETER);
        });
    });
    ...
    describe('@Controller', function () {
        it('should add controller information and try to apply it', function () {
            var adapter = {};
            function target() { }
            annotations.Controller(adapter)(target);
    ...
    describe('@Middle', function () {
        it('should add middleware information', function () {
            var adapter = {};
            function target() { }
            annotations.Middle('/path')(target, 'method', {});
    ...
    describe('HTTP verbs', function () {
        it('should add a get route to configuration object', function () {
            var getDecorator = annotations.Get('/path');
            function target() { }
            ;
        ...
        it('should add a post route to configuration object', function () {
            var getDecorator = annotations.Post('/path');
            function target() { }
            ;
            getDecorator(target, 'path', {});
            assert.equal(target.$$controllerConfiguration.routes.length, 1);
        ...
        it('should add a put route to configuration object', function () {
            var getDecorator = annotations.Put('/path');
            function target() { }
            ;
            getDecorator(target, 'path', {});
            assert.equal(target.$$controllerConfiguration.routes.length, 1);
        ...
        it('should add a delete route to configuration object', function () {
            var getDecorator = annotations.Delete('/path');
            function target() { }
            ;
            getDecorator(target, 'path', {});
            assert.equal(target.$$controllerConfiguration.routes.length, 1);
