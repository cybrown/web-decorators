...
describe('Decorators', function () {
    describe('@AdapterParam', function () {
        it('should add parameter request information from adapter to configuration', function () {
            function target() { }
            ;
            ...
            assert.equal(target.$$controllerConfiguration.methodsParameters['method'][0].type, interfaces_1.ParameterType.ADAPTER_PARAMETER);
        });
    });
